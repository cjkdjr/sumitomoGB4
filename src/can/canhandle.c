...
void Make_Sumitomo_0002_s(sumitomo_parm_grp_0002_t *sumitomo_0002) {
    ...
    memcpy(sumitomo_0002->MainteTimeFromWeb_2, TdfSetData.MainteTimeFromWeb + 6, 6);
    memcpy(sumitomo_0002->MainteTimeFromWeb_3, TdfSetData.MainteTimeFromWeb + 12, 6);
    memcpy(sumitomo_0002->MainteTimeFromWeb_4, TdfSetData.MainteTimeFromWeb + 18, 6);
    memcpy(sumitomo_0002->MainteTimeFromWeb_5, TdfSetData.MainteTimeFromWeb + 24, 6);
}
...
void Make_Sumitomo_0003_s(sumitomo_parm_grp_0003_t *sumitomo_0003) {
    ...
    memcpy(sumitomo_0003->MainteTimeFromWeb_2, TdfSetData.MainteTimeFromWeb + 6, 6);
    memcpy(sumitomo_0003->MainteTimeFromWeb_3, TdfSetData.MainteTimeFromWeb + 12, 6);
    memcpy(sumitomo_0003->MainteTimeFromWeb_4, TdfSetData.MainteTimeFromWeb + 18, 6);
    memcpy(sumitomo_0003->MainteTimeFromWeb_5, TdfSetData.MainteTimeFromWeb + 24, 6);
}
...
void Make_Sumitomo_0004_s(sumitomo_parm_grp_0004_t *sumitomo_0004) {
    ...
    memcpy(sumitomo_0004->MainCtlrPartsNum_2, TdfSetData.MainCtltPartsNum + 6, 6);
    memcpy(sumitomo_0004->MainCtlrSerialNum_1, TdfSetData.MainCtltSerialNum, 6);
    memcpy(sumitomo_0004->MainCtlrSerialNum_2, TdfSetData.MainCtltSerialNum + 6, 5);
    ...
    memcpy(sumitomo_0004->SubCtlrSerialNum_2, TdfSetData.SubCtlrSerialNum + 6, 6);
...
void Make_Sumitomo_0009_s(sumitomo_parm_grp_0009_t *sumitomo_0009) {
     ...
     * 	bit_zone_comm_t bzcommon;	//通用位域结构体
     */
    memcpy(sumitomo_0009->EngineDeviceTestRequest, TdfGetData.EngineDeviceTestRequest, 6);
    //todo  sumitomo_0006->response_type =
}
...
void Make_Sumitomo_0700_s(sumitomo_parm_grp_0700_t *sumitomo_0700) {
    ...
    memcpy(sumitomo_0700->Option_Line_Operation_Time_2nd, TdfSetData.OptionLine + 9, 3);
    memcpy(sumitomo_0700->Overheat_Power_Reduction_Time, TdfSetData.OverheatPowerReduction, 3);
...
void Make_Sumitomo_1302_s(sumitomo_parm_grp_1302_t *sumitomo_1302) {
    ...
    memcpy(sumitomo_1302->OverheatPowerReduction_1, TdfSetData.OverheatPowerReduction, 6);
    memcpy(sumitomo_1302->OverheatPowerReduction_2, TdfSetData.OverheatPowerReduction + 6, 6);
    memcpy(sumitomo_1302->OverheatPowerReduction_3, TdfSetData.OverheatPowerReduction + 12, 3);
...
void Make_Sumitomo_0908_s(sumitomo_parm_grp_0908_t *sumitomo_0908) {
    memcpy(sumitomo_0908->ArmCylBottomPressDst_1, TdfSetData.ArmCylBottomPressDst_1, 6);
    memcpy(sumitomo_0908->ArmCylBottomPressDst_2, TdfSetData.ArmCylBottomPressDst_2, 6);
    memcpy(sumitomo_0908->ArmCylBottomPressDst_3, TdfSetData.ArmCylBottomPressDst_3, 6);
    memcpy(sumitomo_0908->ArmCylBottomPressDst_4, TdfSetData.ArmCylBottomPressDst_4, 3);
}

void Make_Sumitomo_0909_s(sumitomo_parm_grp_0909_t *sumitomo_0909) {
    memcpy(sumitomo_0909->ArmCylRodPressDst_1, TdfSetData.ArmCylRodPressDst_1, 6);
    memcpy(sumitomo_0909->ArmCylRodPressDst_2, TdfSetData.ArmCylRodPressDst_2, 6);
    memcpy(sumitomo_0909->ArmCylRodPressDst_3, TdfSetData.ArmCylRodPressDst_3, 6);
    memcpy(sumitomo_0909->ArmCylRodPressDst_4, TdfSetData.ArmCylRodPressDst_4, 3);
}

void Make_Sumitomo_090A_s(sumitomo_parm_grp_090A_t *sumitomo_090A) {
    memcpy(sumitomo_090A->BoomCylBottomPressDst_1, TdfSetData.BoomCylBottomPressDst_1, 6);
    memcpy(sumitomo_090A->BoomCylBottomPressDst_2, TdfSetData.BoomCylBottomPressDst_2, 6);
    memcpy(sumitomo_090A->BoomCylBottomPressDst_3, TdfSetData.BoomCylBottomPressDst_3, 6);
    memcpy(sumitomo_090A->BoomCylBottomPressDst_4, TdfSetData.BoomCylBottomPressDst_4, 3);

}

void Make_Sumitomo_090B_s(sumitomo_parm_grp_090B_t *sumitomo_090B) {
    memcpy(sumitomo_090B->BoomCylRodPressDst_1, TdfSetData.BoomCylRodPressDst_1, 6);
    memcpy(sumitomo_090B->BoomCylRodPressDst_2, TdfSetData.BoomCylRodPressDst_2, 6);
    memcpy(sumitomo_090B->BoomCylRodPressDst_3, TdfSetData.BoomCylRodPressDst_3, 6);
    memcpy(sumitomo_090B->BoomCylRodPressDst_4, TdfSetData.BoomCylRodPressDst_4, 3);
...
void Make_Sumitomo_090D_s(sumitomo_parm_grp_090D_t *sumitomo_090D) {
    memcpy(sumitomo_090D->HydOilFilterPressDst_1, TdfSetData.HydOilFilterPressDst_1, 6);
    memcpy(sumitomo_090D->HydOilFilterPressDst_2, TdfSetData.HydOilFilterPressDst_2, 6);
    memcpy(sumitomo_090D->HydOilFilterPressDst_3, TdfSetData.HydOilFilterPressDst_3, 6);
    memcpy(sumitomo_090D->HydOilFilterPressDst_4, TdfSetData.HydOilFilterPressDst_4, 3);
...
void Make_Sumitomo_0910_s(sumitomo_parm_grp_0910_t *sumitomo_0910) {
    memcpy(sumitomo_0910->EngineActualSpeedDst_1, TdfSetData.EngineActualSpeedDst_1, 6);
    memcpy(sumitomo_0910->EngineActualSpeedDst_2, TdfSetData.EngineActualSpeedDst_2, 6);
    memcpy(sumitomo_0910->EngineActualSpeedDst_3, TdfSetData.EngineActualSpeedDst_3, 6);
    memcpy(sumitomo_0910->EngineActualSpeedDst_4, TdfSetData.EngineActualSpeedDst_4, 3);
}
...
void Make_Sumitomo_0917_s(sumitomo_parm_grp_0917_t *sumitomo_0917) {
    memcpy(sumitomo_0917->EngineOilPressDst_1, TdfSetData.EngineOilPressDst_1, 6);
    memcpy(sumitomo_0917->EngineOilPressDst_2, TdfSetData.EngineOilPressDst_2, 6);
    memcpy(sumitomo_0917->EngineOilPressDst_3, TdfSetData.EngineOilPressDst_3, 6);
    memcpy(sumitomo_0917->EngineOilPressDst_4, TdfSetData.EngineOilPressDst_4, 3);

}

void Make_Sumitomo_0918_s(sumitomo_parm_grp_0918_t *sumitomo_0918) {
    memcpy(sumitomo_0918->EngineOilPressRiseTimeDst_1, TdfSetData.EngineOilPressRiseTimeDst_1, 6);
    memcpy(sumitomo_0918->EngineOilPressRiseTimeDst_2, TdfSetData.EngineOilPressRiseTimeDst_2, 6);
    memcpy(sumitomo_0918->EngineOilPressRiseTimeDst_3, TdfSetData.EngineOilPressRiseTimeDst_3, 2);
}
...
void Make_Sumitomo_091A_s(sumitomo_parm_grp_091A_t *sumitomo_091A) {
    memcpy(sumitomo_091A->EngineLoadRatioDst_1, TdfSetData.EngineLoadRatioADst_1, 6);
    memcpy(sumitomo_091A->EngineLoadRatioDst_2, TdfSetData.EngineLoadRatioADst_2, 6);
    memcpy(sumitomo_091A->EngineLoadRatioDst_3, TdfSetData.EngineLoadRatioADst_3, 6);
    memcpy(sumitomo_091A->EngineLoadRatioDst_4, TdfSetData.EngineLoadRatioADst_4, 3);
}

void Make_Sumitomo_091B_s(sumitomo_parm_grp_091B_t *sumitomo_091B) {
    memcpy(sumitomo_091B->EngineLoadRatioSPDst_1, TdfSetData.EngineLoadRatioSPDst_1, 6);
    memcpy(sumitomo_091B->EngineLoadRatioSPDst_2, TdfSetData.EngineLoadRatioSPDst_2, 6);
    memcpy(sumitomo_091B->EngineLoadRatioSPDst_3, TdfSetData.EngineLoadRatioSPDst_3, 6);
    memcpy(sumitomo_091B->EngineLoadRatioSPDst_4, TdfSetData.EngineLoadRatioSPDst_4, 3);
}

void Make_Sumitomo_091C_s(sumitomo_parm_grp_091C_t *sumitomo_091C) {
    memcpy(sumitomo_091C->EngineLoadRatioHDst_1, TdfSetData.EngineLoadRatioHDst_1, 6);
    memcpy(sumitomo_091C->EngineLoadRatioHDst_2, TdfSetData.EngineLoadRatioHDst_2, 6);
    memcpy(sumitomo_091C->EngineLoadRatioHDst_3, TdfSetData.EngineLoadRatioHDst_3, 6);
    memcpy(sumitomo_091C->EngineLoadRatioHDst_4, TdfSetData.EngineLoadRatioHDst_4, 3);
}

void Make_Sumitomo_091D_s(sumitomo_parm_grp_091D_t *sumitomo_091D) {
    memcpy(sumitomo_091D->EngineLoadRatioADst_1, TdfSetData.EngineLoadRatioADst_1, 6);
    memcpy(sumitomo_091D->EngineLoadRatioADst_2, TdfSetData.EngineLoadRatioADst_2, 6);
    memcpy(sumitomo_091D->EngineLoadRatioADst_3, TdfSetData.EngineLoadRatioADst_3, 6);
    memcpy(sumitomo_091D->EngineLoadRatioADst_4, TdfSetData.EngineLoadRatioADst_4, 3);
}

void Make_Sumitomo_091E_s(sumitomo_parm_grp_091E_t *sumitomo_091E) {
    memcpy(sumitomo_091E->SupplyPumpPressDst_1, TdfSetData.SupplyPumpPressDst_1, 6);
    memcpy(sumitomo_091E->SupplyPumpPressDst_2, TdfSetData.SupplyPumpPressDst_2, 6);
    memcpy(sumitomo_091E->SupplyPumpPressDst_3, TdfSetData.SupplyPumpPressDst_3, 6);
    memcpy(sumitomo_091E->SupplyPumpPressDst_4, TdfSetData.SupplyPumpPressDst_4, 3);
}
...
void Make_Sumitomo_0925_s(sumitomo_parm_grp_0925_t *sumitomo_0925) {
    memcpy(sumitomo_0925->InterCoolerTempDst_1, TdfSetData.InterCoolerTempDst_1, 6);
    memcpy(sumitomo_0925->InterCoolerTempDst_2, TdfSetData.InterCoolerTempDst_2, 6);
    memcpy(sumitomo_0925->InterCoolerTempDst_3, TdfSetData.InterCoolerTempDst_3, 6);
    memcpy(sumitomo_0925->InterCoolerTempDst_4, TdfSetData.InterCoolerTempDst_4, 3);
...
void Make_Sumitomo_0927_s(sumitomo_parm_grp_0927_t *sumitomo_0927) {
    memcpy(sumitomo_0927->CommonRailPressDst_1, TdfSetData.CommonRailPressDst_1, 6);
    memcpy(sumitomo_0927->CommonRailPressDst_2, TdfSetData.CommonRailPressDst_2, 6);
    memcpy(sumitomo_0927->CommonRailPressDst_3, TdfSetData.CommonRailPressDst_3, 6);
    memcpy(sumitomo_0927->CommonRailPressDst_4, TdfSetData.CommonRailPressDst_4, 3);
}

void Make_Sumitomo_0928_s(sumitomo_parm_grp_0928_t *sumitomo_0928) {
    memcpy(sumitomo_0928->CommonRailDiffPressDst_1, TdfSetData.CommonRailDiffPressDst_1, 6);
    memcpy(sumitomo_0928->CommonRailDiffPressDst_2, TdfSetData.CommonRailDiffPressDst_2, 6);
    memcpy(sumitomo_0928->CommonRailDiffPressDst_3, TdfSetData.CommonRailDiffPressDst_3, 6);
    memcpy(sumitomo_0928->CommonRailDiffPressDst_4, TdfSetData.CommonRailDiffPressDst_4, 3);
}
...
void Make_Sumitomo_092A_s(sumitomo_parm_grp_092A_t *sumitomo_092A) {
    memcpy(sumitomo_092A->AirconditionerBlowerDst_1, TdfSetData.AirconditionerBlowerDst_1, 6);
    memcpy(sumitomo_092A->AirconditionerBlowerDst_2, TdfSetData.AirconditionerBlowerDst_2, 6);
    memcpy(sumitomo_092A->AirconditionerBlowerDst_3, TdfSetData.AirconditionerBlowerDst_3, 6);
}

void Make_Sumitomo_092B_s(sumitomo_parm_grp_092B_t *sumitomo_092B) {
    memcpy(sumitomo_092B->AirconditionerTargetTempDst_1, TdfSetData.AirconditionerTargetTempDst_1, 6);
    memcpy(sumitomo_092B->AirconditionerTargetTempDst_2, TdfSetData.AirconditionerTargetTempDst_2, 6);
    memcpy(sumitomo_092B->AirconditionerTargetTempDst_3, TdfSetData.AirconditionerTargetTempDst_3, 6);
    memcpy(sumitomo_092B->AirconditionerTargetTempDst_4, TdfSetData.AirconditionerTargetTempDst_4, 3);
}
...
void Make_Sumitomo_0B00_s(sumitomo_parm_grp_0B00_t *sumitomo_0B00) {
    //todo bit_zone_comm_t bzcommon;
    memcpy(sumitomo_0B00->Manual_Re_Gen_Notification, TdfSetData.MainteTimeFromWeb, 6);
